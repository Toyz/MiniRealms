...
using GameConsole.ManualInterpreter.Utilities;
using GameConsole.Output;

namespace GameConsole.ManualInterpreter
{
    /// <summary>
    ...
    public class ManualInterpreter : ICommandInterpreter
    {
        ...
        /// Name of the command. This is the name user must enter into the <see cref="System.Console"/> to execute the command.
        /// </param>
